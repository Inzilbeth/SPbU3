...
namespace MyNUnitLib
{
    ...
    public static class MyNUnit
    {
        ...
        /// <summary>
        /// Runs all the tests from specified path and returns the results.
        /// </summary>
        ...
        /// <summary>
        /// Prepares the assemblies and runs all the tests using path.
        /// </summary>
        ...
        /// <summary>
        /// Loads all the types from the assemblies inside the collection of binaries.
        /// </summary>
        private static IEnumerable<Type> GetTypes(IEnumerable<byte[]> assemblies)
